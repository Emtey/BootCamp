...
namespace LibraryBusinessTier
{
    ...
    {        
        ...
        public void RenewMember(short memberNumber)
        {
            try
            {
                myAccess.RenewMember(memberNumber);
            }
            catch (LibraryException)
            {
                throw new LibraryException(ErrorCode.RenewMemberFailed);
            }
        }
        ...
        public void ConvertJuvenile(short memberNumber)
        {
            try
            {
                myAccess.ConvertJuvenile(memberNumber);
            }
            catch (LibraryException)
            {
                throw new LibraryException(ErrorCode.ConvertJuvenileFailed);
            }
        }
        /// <summary>
        /// Adds a new item.
        ...
        public void AddItem(int isbn, string title, string author, string loanable)
        {
            try
            {
                myAccess.AddItem(isbn,title,author,loanable);
            }
            catch (LibraryException)
            {
                throw new LibraryException(ErrorCode.AddItemFailed);
            }
        }
    }
}
